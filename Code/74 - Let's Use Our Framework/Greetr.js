;(function greetr(global, $) {
    ...
    Greetr.prototype = {
        ...
        // chainabe methods return their own containing object
        ...
        log: function() {
            if(console) {
                console.log([logMessages[this.language], this.fullName()].join(': '))
            }
    ...
    // attach our Greetr to the global object, and provide a shorthand '$G' for ease of our poor fingers
